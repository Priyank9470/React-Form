...
const RegistrationForm = () => {
  ...
  const [registrationModel, handleChange, registrationModelError, dropOption, checkBoxList,
    handleImageChange, Validate, handleReset, handleSubmit, isSubmitted] = useMyFormHook({
      name: "",
      email: "",
      phoneNumber: "",
      selectCity: false,
      ...
      {!isSubmitted ? (
        <form onSubmit={handleSubmit}>
          ...
          <div className="inline" style={{ marginTop: 30 }}>
            ...
            {/* Submit button */}
            {/* <Link to="/welcomepage"> */}
            <button to="/welcomepage" type="submit" className="btn btn-outline-success" onClick={Validate} style={{ width: 90 }}>
              Submit
            </button>
            {/* </Link> */}
